ActionController::Routing::Routes.draw do |map|
  ...
  map.resources :users, :as => "people", :member => { :lock => :put, :unlock => :put, :directory => :get, :update_password => :put, :new_email_profile => :get, :send_email_profile => :post, :settings => :get, :newsfeed => :get, :organizations => :get, :follow => :post, :unfollow => :post, :profile_stats => :get } do |user|
